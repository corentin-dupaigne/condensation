  ...
  return (
    <>
      <main className="relative flex min-h-screen grow items-center justify-center overflow-hidden px-6 pt-24 pb-16">
        ...
        <div className="pointer-events-none absolute right-0 top-1/4 h-100 w-100 rounded-full bg-secondary/5 blur-[100px]" />
            ...
            <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between px-1">
                  <label
                    htmlFor="password"
                    className="block text-xs font-bold tracking-[0.2em] uppercase text-primary/80"
                  >
                    Password
                  </label>
                  <a
                    href="#"
                    className="text-xs font-bold tracking-widest uppercase text-secondary/80 transition-colors hover:text-secondary"
                  >
                    Forgot password?
                  </a>
                </div>
              ...
              <button
                type="submit"
                className="mt-2 w-full cursor-pointer rounded-xl bg-linear-to-r from-primary to-primary-container py-4 font-headline text-base font-black tracking-tight text-on-primary-fixed shadow-[0_0_20px_rgba(213,117,255,0.25)] transition-all hover:brightness-110 active:scale-[0.98]"
              >
                Sign In
              </button>
            </form>
